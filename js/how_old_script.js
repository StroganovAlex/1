...
`"${age}"? <br>Попробуй еще раз, только на этот раз укажи возраст цифрами!`; // Тебе либо больше 9000000 млрд лет, либо возраст введен с ошибкой!;    
...
if (age <= 16) {  // Тебе меньше 16 лет!;
    ...
    headText = `"${age}"? <br>Попробуй еще раз, только на этот раз укажи возраст цифрами!`;
};
document.getElementById("ages").innerHTML = headText;
*/
