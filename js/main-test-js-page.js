function update_header() { // функция обновления графического интерфейса header
    let headText;
    ...
    if (age === null) {  // пользователь отказался вводить возраст
        ...
        `'${age}' - что это? <br>Попробуй еще раз, только укажи свой возраст цифрами!`; // Тебе либо больше 9000000 млрд лет, либо возраст введен с ошибкой!;    
    }
...
if (age === null) {  // пользователь отказался вводить возраст
    ...
    if (age <= 16) {  // Тебе меньше 16 лет!;
        ...
        headText = `'${age}' - что это? <br>Попробуй еще раз, только укажи свой возраст цифрами!`;
};
